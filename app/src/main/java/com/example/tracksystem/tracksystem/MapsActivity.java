...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(assuit).title("Assuit").icon(BitmapDescriptorFactory.fromResource(R.drawable.station_marker2)));
        LatLng Malawy = new LatLng(27.732873, 30.850035);
        mMap.addMarker(new MarkerOptions().position(Malawy).title("Malawy").icon(BitmapDescriptorFactory.fromResource(R.drawable.station_marker2)));
        LatLng Minya = new LatLng(28.096781, 30.753852);
        mMap.addMarker(new MarkerOptions().position(Minya).title("Minya").icon(BitmapDescriptorFactory.fromResource(R.drawable.station_marker2)));
